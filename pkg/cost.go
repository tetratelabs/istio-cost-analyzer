...
// todo transform this into a separate GCP thing that transforms gcp.json into gcp_pricing.json
//func (c *CostAnalysis) CalculateEgressGCP(calls []*Call) (float64, error) {
//	totalCost := 0.00
//	for i, v := range calls {
